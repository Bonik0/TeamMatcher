export const formatDateTime = (interval) => {
	...
	const endDateYear = Intl.DateTimeFormat("RU-ru", { year: "numeric" }).format(
		endDate,
	);
	const endDateMonth = Intl.DateTimeFormat("RU-ru", { month: "2-digit" })
		.format(endDate);
	const endDateDay = Intl.DateTimeFormat("RU-ru", { day: "2-digit" }).format(
		endDate,
	);
	const endDateHour = Intl.DateTimeFormat("RU-ru", { hour: "2-digit" }).format(
		endDate,
	);
	const endDateMinute = "00";
	const startDateHour = Intl.DateTimeFormat("RU-ru", { hour: "2-digit" })
		.format(startDate);
