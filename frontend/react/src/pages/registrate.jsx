...
const RegisterPage = () => {
	...
	const handleSubmit = async (e) => {
		...
		if (formData.surname.length === 0) {
			handleErrorsChange("Необходимо заполнить поле", "surname");
			return;
		}
		...
		if (response.status == 403) {
			window.location.href = getURLtoEmailVetify(
			...
			<div style={defaultStyles.card}>
				...
				<form onSubmit={handleSubmit} style={defaultStyles.form}>
					<input
						...
						style={{
							...defaultStyles.input,
							borderColor: errors.first_name === false ? "#1e90ff" : "red",
						}}
					...
					<input
						...
						style={{
							...defaultStyles.input,
							borderColor: errors.surname === false ? "#1e90ff" : "red",
						}}
					...
					<input
						...
						style={{
							...defaultStyles.input,
							borderColor: errors.patronymic === false ? "#1e90ff" : "red",
						}}
					...
					<select
						...
						style={{
							...defaultStyles.input,
							borderColor: errors.role === false ? "#1e90ff" : "red",
					...
					<div style={styles.passwordWrapper}>
						<input
							...
							style={{
								...defaultStyles.input,
								borderColor: errors.confirmPassword === false
									? "#1e90ff"
									: "red",
							}}
