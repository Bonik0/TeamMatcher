...
from core.models.rabbitmq.config import get_url
...
def celery_match_task(self, project_id: int) -> None:
    from app.match.dependencies.utils import get_competence_similarity_utils, get_match_utils, get_user_project_role_similarity_utils
